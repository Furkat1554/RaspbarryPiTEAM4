...
<html>
    ...
    <body>
        ...
        <div id="edit-pointOfInterest" class="content scaffold-edit" role="main">
            ...
            <g:uploadForm name="uploadMediaFile" action="uploadMediaFile">
                <g:hiddenField name="id" value="${this.announcement?.id}" />
                <input type="file" name="mediaFile" />
                <fieldset class="buttons">
                    <input class="save" type="submit" value="${message(code: 'announcement.featuredImage.upload.label', default: 'Upload')}" />
                </fieldset>
            </g:uploadForm>
        </div>
    </body>
